...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.fcs = nn.ModuleList([nn.Linear(2048, n_classes) for _ in range(label_num)])
        self.dropout = nn.Dropout(dropout)

        self.embedding = nn.EmbeddingBag(vocab_size, 256, sparse=True)
        self.textfc1 = nn.Linear(256,128)
        self.textfc2 = nn.Linear(128,64)
