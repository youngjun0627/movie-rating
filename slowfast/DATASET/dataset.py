...
class VideoDataset(Dataset):
    def __init__(self, directory,size=224, mode = 'train', frame_sample_rate=1, cut_time=1, play_time=680,transform=None,sub_classnum=4, label_num = 1, stride_num=1):
        folder = directory
        self.size = size
        ...
        if label_num==1:
            ...
            print('weights ->  {}'.format(self.get_class_weight()))
        else:
...
if __name__=='__main__':
    ...
    path = '/home/guest0/uchan/slowfast/UTILS/tt'
