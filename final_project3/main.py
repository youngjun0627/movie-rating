...
from MODELS import slowfastnet, x3d, multi_slowfastnet, multi_x3d, efficientnet, multi_x3d_plot_multitask, multi_x3d_plot, multi_x3d_plot_multitask_audio, multi_slowfastnet_plot_multitask_audio, slowfast_lstm, x3d_lstm
    ...
    ### multi ###
        ...
        if params['model']=='slowfast':
            ...
            if params['use_plot']:
                ...
                train_dataset.generate_text_pipeline(vocab,tokenizer)
                val_dataset.generate_text_pipeline(vocab, tokenizer) 
                model = x3d_lstm.generate_model('S', n_classes = params['num_classes'], label_num = params['label_num'], vocab_size = len(vocab))
