...
from MODELS import slowfastnet, x3d, multi_slowfastnet, multi_x3d, efficientnet, multi_x3d_plot_multitask, multi_x3d_plot
...
from CONFIG.x3d_multi_plot_multitask import params
    ...
    ### multi ###
        ...
        if params['model']=='slowfast':
            ...
            if params['use_plot']:
                ...
                train_dataset.generate_text_pipeline(vocab,tokenizer)
                val_dataset.generate_text_pipeline(vocab, tokenizer) 
                model = multi_x3d_plot_multitask.generate_model('S', n_classes = params['num_classes'], label_num = params['label_num'], vocab_size = len(vocab))
