...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.fcs = nn.ModuleList([nn.Linear(2048+self.audio_size, n_classes) for _ in range(label_num)])
        self.classifier = nn.Linear(2048 + self.audio_size, n_classes * label_num)
        self.dropout = nn.Dropout(dropout)


        self.genrefc = nn.Linear(2048+self.audio_size, 9)
        self.agefc = nn.Linear(2048+self.audio_size, 4)
