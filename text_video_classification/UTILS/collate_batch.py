...
def Collate_batch(batch):
    video_list, text_list, label_list, genre_list, age_list = [], [], [], [], []
    for (_video, _text, _, _label, _age, _genre) in batch:
    ...
    return video_list, text_list, label_list, age_list, genre_list
